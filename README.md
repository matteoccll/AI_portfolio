...
| **AP Outreach Agent** | Claude Code-orchestrated six-component pipeline for autonomous job-application outreach across NHS Trusts, private practices, and third-sector organisations. Built and operational — running live outreach in the London area. The codebase is kept private out of discretion given the sensitivity of the work. | [spec](software/ap-outreach-agent/spec.md) · code on request |
